...
class ChangeSetTableCell : UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    var items: [changeSetItem] = [
        changeSetItem(id: "[Dp-552]", description: "Transaction reporting ekranındaki sql sorgusunun iyileştirilmesi"),
        changeSetItem(id: "[Dp-552]", description: "Transaction reporting ekranındaki sql sorgusunun iyileştirilmesi"),
        changeSetItem(id: "[Dp-552]", description: "Transaction reporting ekranındaki sql sorgusunun iyileştirilmesi"),
        changeSetItem(id: "[Dp-552]", description: "Transaction reporting ekranındaki sql sorgusunun iyileştirilmesi"),
        changeSetItem(id: "[Dp-552]", description: "Transaction reporting ekranındaki sql sorgusunun iyileştirilmesi"),
